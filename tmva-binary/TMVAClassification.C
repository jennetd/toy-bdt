// Adapted from https://root.cern.ch/doc/v610/TMVAClassification_8C.html
// by Jennet Dickinson
// Jan 13, 2020
...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   //   dataloader->AddSpectator( "label", 'D' );
   ...
   string details = "nTrain_Signal="+to_string(nsig)+":nTrain_Background="+to_string(nbkg)+":SplitMode=Random:NormMode=NumEvents:!V";
     
   dataloader->PrepareTrainingAndTestTree( mycuts, mycutb, details.c_str()) ;
   // ### Book MVA methods
   //
